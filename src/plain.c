...
static OSyncConvCmpResult compare_plain(OSyncObjFormat *format, const char *leftdata, unsigned int leftsize, const char *rightdata, unsigned int rightsize, void *user_data, OSyncError **error)
{
...
static osync_bool copy_plain(OSyncObjFormat *format, const char *input, unsigned int inpsize, char **output, unsigned int *outpsize, void *user_data, OSyncError **error)
{
...
static osync_bool destroy_plain(OSyncObjFormat *format, char *input, unsigned int inpsize, void *user_data, OSyncError **error)
{
	g_free(input);
